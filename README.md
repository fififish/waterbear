...
Sisi Duan, Haibin Zhang, and Boxin Zhao. "WaterBear: Practical Asynchronous BFT Matching Security Guarantees of Partially Synchronous BFT." Cryptology ePrint Archive (2022).
